                          ...
                          <div class="corporate-navigation-bottom">
                            <help-desk-summary class="corporate-helpdesk">
                              <div class="row corporate-helpdesk-container">
                                ...
                                <div class="question-mark-text">
                                  ...
                                  <div class="row">
                                    <div class="col-xs-12 ng-binding" ng-bind="&#39;Helpdesk.Line2&#39;|loginTranslate">Please contact your relationship manager
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="corporate-footer">
                              <div class="corporate-footer-links">
                                <a href="https://pigetandgalland.com/piguet-galland-la-mode/" target="_blank" class="ng-binding">About Piguet Galland</a> | <a href="https://pigetandgalland.com/conditions-dutilisation/" target="_blank" class="ng-binding">Terms of Use</a> | <a href="https://pigetandgalland.com/cookies/" target="_blank" class="ng-binding">Cookies
                                </a>
                              </div>
                            </div>
                          </div>
              ...
              <login-content class="ng-isolate-scope">
                  ...
                  <div class="col-xs-11 pull-right">
                    <switch-language class="ng-isolate-scope">
                      <div class="btn-group login-dropdown-bright" ng-class="{ open: status.isopen }" style="width:200px; display:block">
                        <button type="button" class="btn dropdown-toggle ng-binding" ng-click="status.isopen = !status.isopen" aria-label="Français">English<span class="btn-arrow-down"></span>
                        </button>
                ...
                <div class="row">
                  <div class="detail-title-container">
                    <h1 class="detail-title text-left ng-binding">Login</h1>
                  </div>
                </div>
                <div class="row">
                          ...
                          <div class="inline-form detail-form-content ng-scope">
                            <form role="form" name="login_form" novalidate="" method="post" class="ng-pristine ng-valid-server ng-invalid ng-invalid-required">
                              ...
                              <div class="inline-form-group">
                                <input name="email" class="login-input-bright ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" type="text" aria-label="Access Code" placeholder="Access Code" id="email" autocomplete="off" required="" tabindex="1" aria-invalid="true">
                              </div>
                              <div class="inline-form-group">
                                <input name="password" class="login-input-bright ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" type="password" aria-label="Password" placeholder="Password" id="" ="password" autocomplete="off" required="" tabindex="2" aria-invalid="true">
                              </div>
                              <div class="inline-form-group" spinner="api/login$" spinner-dark="true" style="min-height: 50px; position: relative;">
                                <input ng-hide="loading" type="submit" class="login-button-primary-bright" ng-disabled="!login_form.$valid" value="Use &#39;Enter&#39; to confirm" aria-label="Use &#39;Enter&#39; to confirm" tabindex="3" aria-hidden="false">
                              </div>
