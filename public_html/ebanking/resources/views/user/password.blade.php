...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : Change Password</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/password/edit', 'method'=>'post','autocomplete' => 'off', 'role'=>'form', 'class'=>'form-horizontal')) }}
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label for="old_password" class="col-sm-3 control-label">Old Password</label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control input-lg" placeholder="Enter Old Password" id="old_password" name="old_password">
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
