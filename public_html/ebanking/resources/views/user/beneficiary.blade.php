...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : Add Account</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/beneficiary/create', 'method'=>'post','role'=>'form', 'class'=>'form_horizontal')) }}
                                        <div class="form-group">
                                            <label for="account_dets" class="col-sm-2 control-label">Beneficiary Details</label>
                                            <div class="col-sm-5">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="col-sm-10">
                                            @if(Session::get('beneficiary_message'))
                                                <div class="alert alert-info" role="alert">{{Session::get('beneficiary_message')}}</div>
                                            @endif
                                        </div>
