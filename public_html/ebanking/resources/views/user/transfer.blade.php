...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : Transfers</title>
    ...
    <!-- Page Container -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Transfer Details</h4>
                                </div>
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Transfers</label>
                                            <div class="col-sm-5">
                                                <input class="form-control" id="account_number" name="account_number" placeholder="Account Number">
                                            </div>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="transfer_to" name="transfer_to" style="width: 100%;" data-placeholder="Transfer to...">
                                                    <option>Own Account Transfer</option>
                                                    <option>Transfer to Piguet Galland</option>
                                                    <option>Transfer to Other Banks</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Beneficiary</label>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="beneficiary" name="beneficiary" style="width: 100%;" data-placeholder="Transfer to...">
                                            ...
                                            <div class="col-sm-2">
                                                <a style="color: blue;" href="beneficiary">Create Beneficiary</a>
                                            </div>
                                            <div class="col-sm-3">
                                                <a href="#" data-toggle="modal" data-target="#modal-notice"><button type="submit" class="btn btn-danger pull-right">Transfer</button></a>
                                            </div>
                                        </div>
                                </div>
                            </div>
        ...
        <!-- Terms Modal -->
                <div class="modal fade" id="modal-notice" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="block block-themed block-transparent remove-margin-b">
                                ...
                                <div class="block-content">
                                    <h3 style="text-align:left; font-size:1.1em">Bank Account Notice</h3>
                                    <p>
                                        Your account is not fully configured for our transfer service. Please contact our Accounts Department.
                                    </p>
                                </div>
                            </div>
