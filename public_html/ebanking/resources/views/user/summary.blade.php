...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : User Summary</title>
                                ...
                                <div class="panel panel-white stats-widget">
                                    <div class="panel-body">
                                        <div class="panel-header">
                                            ...
                                            @foreach($data['account_details'] as $account)
	                                            <span class="pull-right">{{$account->account_number}}</span>
	                                        @endforeach
                                        </div>
                                        <div class="divider"></div>
                                        <div class="pull-left">
                                            <span><h3>{{Session::get('first_name')}} {{Session::get('last_name')}}</h3></span>
                                            @foreach($data['account_details'] as $account)
	                                            <span class="stats-number"><i class="fa fa-eur"></i>{{$account->account_balance}}</span>
	                                        @endforeach
                                            <a href="accountdetails"><p style="color: blue;" class="stats-info">View Account Details</p></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    @if(!$data['transactions']->isEmpty())
                                        <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="hidden-xs hidden-sm text-left"style="width: 20%;">Account Number</th>
                                                    <th style="width: 15%;">Amount (EUR)</th>
                                                    <th class="hidden-xs hidden-sm" style="width: 40%;">Description</th>
                                                    <!--<th style="width: 15%;">Charges (EUR)</th>-->
                                                </tr>
                                            </thead>
                                            <tbody>
                                       ...
                                       @else
                                            You have no recently approved transactions.
                                    @endif
                                    </div>
                                </div>
                            </div>
