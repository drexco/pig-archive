...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : Factures</title>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Bill</label>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="account_id" name="account_id" style="width: 100%;" data-placeholder="Select Account...">
                                                    <option value="0">Select Account Number</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="transfer_to" name="transfer_to" style="width: 100%;" data-placeholder="Bill...">
                                                    <option>Select Category</option>
                                                    <option>Phone Bills</option>
                                                    <option>Televison & Cable Bills</option>
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Biller</label>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="biller" name="biller" style="width: 100%;" data-placeholder="Biller...">
                                            ...
                                            <div class="col-sm-5">
                                                <a href="#" data-toggle="modal" data-target="#modal-notice"><button type="submit" class="btn btn-danger pull-right">Pay</button></a>
                                            </div>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-content">
                            <div class="block block-themed block-transparent remove-margin-b">
                                ...
                                <div class="block-content">
                                    ...
                                    <p>
                                        Your account is not fully configured for our bill payment service. Please contact our Accounts Department.
                                    </p>
                                </div>
                            </div>
