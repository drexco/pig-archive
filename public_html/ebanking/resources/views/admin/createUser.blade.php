...
<html lang="zxx">
    <head>
        ...
        <title>Piguet Galland : Create User</title>
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/users/create', 'method'=>'post','role'=>'form', 'class'=>'form_horizontal')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="address_one" name="address_one" placeholder="Address I">
                                            </div>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="address_two" name="address_two" placeholder="Address II">
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="next_of_kin" name="next_of_kin" placeholder="Next of Kin">
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
